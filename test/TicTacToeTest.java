...
public class TicTacToeTest {
    ...
    @Test
    public void disabledAutomaticChangeTurn(){
        ITicTacToe ticTacToe = new TicTacToe();
        ticTacToe.create();
        ticTacToe.disableAutomaticShiftChange();
        Assert.assertFalse(ticTacToe.getAutomaticShiftChange());
    }
    @Test
    public void activateAutomaticChangeTurn(){
        ITicTacToe ticTacToe = new TicTacToe();
        ticTacToe.create();
        ticTacToe.activateAutomaticShiftChange();
        Assert.assertTrue(ticTacToe.getAutomaticShiftChange());
    }
    @Test
    public  void multMarkMoveX(){
        ITicTacToe ticTacToe = new TicTacToe();
        ticTacToe.create();
        ticTacToe.disableAutomaticShiftChange();
        ticTacToe.markMove(0,0);
